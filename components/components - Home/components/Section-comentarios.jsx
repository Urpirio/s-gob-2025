...
export default function SectionComentarios() {
    return(
        ...
        <section className="flex flex-col md:flex-row w-full items-center justify-between gap-8 md:gap-0 px-4 md:px-0">
            <span className="transition hover:scale-110 active:scale-95 cursor-pointer rounded-full p-2 bg-blue-50 shadow-md">
                <FaArrowLeft className="w-12 h-12 md:w-[60px] md:h-[60px] text-blue-500" />
            </span>
            ...
            <span className="transition hover:scale-110 active:scale-95 cursor-pointer rounded-full p-2 bg-blue-50 shadow-md">
                <FaArrowRight className="w-12 h-12 md:w-[60px] md:h-[60px] text-blue-500" />
            </span>
        </section>
    </article>
    )
