...
export default function SectionComentarios() {
  ...
  return (
    <section className="py-10 flex flex-col gap-10">
      ...
      <div
        id="CardContainer"
        className="flex  w-full md:px-10 justify-center"
      ...
      >
        <Carousel
          ...
          nextIcon={<IoIosArrowForward className="text-4xl hidden sm:flex text-primary" />}
          prevIcon={<IoIosArrowBack className="text-4xl hidden sm:flex text-primary" />}
