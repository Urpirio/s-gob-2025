...
export default function SectionSearch() {
  return (
     ...
     <section className="flex-1 flex flex-col justify-center items-center px-4 pt-20 pb-10">
        ...
        <div className="bg-gray-300 px-0 w-full max-w-xl flex justify-between items-center rounded-[25px]  h-[55px] ">
           <div className="bg-blue-500 hover:bg-blue-300 transition  duration-300 p-2 ml-2 flex items-center justify-center w-[45px] rounded-full h-[45px]">
            <CiSearch className="text-3xl text-white "/>
          </div>
        <input type="text" className="bg-gray-300  focus:outline-none text-2xl  w-full max-w-xl flex items-center rounded-[25px] h-[55px]"/>
         
          <div className="flex bg-white focus:outline-none items-center  rounded-full p-2 pr-3 mr-2 ml-2">
            <input
