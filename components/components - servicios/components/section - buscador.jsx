...
export default function SectionBuscador() {
  return (
    <section className="flex justify-center items-center py-5">
        <div className="flex items-center justify-between rounded-4xl w-[60%] h-15 px-2 py-1 bg-[#F3F3F3]">
            <button className="h-12 w-12 flex justify-center items-center rounded-[100%] bg-[#0088FF]">
            ...
            <button className=" flex items-center gap-2  p-2 rounded-3xl bg-white ">
